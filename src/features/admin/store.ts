...
const initialNotifications: AdminNotification[] = [
  ...
  { id: "notification-sent", type: "sent", title: "Документ отправлен", message: "Приказ передан на согласование.", createdAt: "Сегодня, 10:30", isRead: false, documentId: "doc-1" },
  { id: "notification-returned", type: "returned", title: "Документ возвращён", message: "Документ возвращён на доработку.", createdAt: "Вчера, 16:10", isRead: true, documentId: "doc-2" },
  { id: "notification-overdue", type: "overdue", title: "Документ просрочен", message: "Срок согласования документа истёк.", createdAt: "Вчера, 09:00", isRead: false, documentId: "doc-3" },
  { id: "notification-assigned", type: "assigned", title: "Назначен ответственный", message: "Вы назначены ответственным за рассмотрение документа.", createdAt: "02.08.2026, 13:45", isRead: true, documentId: "doc-4" },
];

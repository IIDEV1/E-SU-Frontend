...
export function StatusBadge({ status, className = "" }: { status: DocumentStatus | AdminUserStatus | ToggleStatus; className?: string }) {
...
export function PriorityBadge({ priority, className = "" }: { priority: DocumentPriority; className?: string }) {
